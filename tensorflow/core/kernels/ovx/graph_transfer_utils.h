...
#ifndef TENSORFLOW_PLATFORM_OVX_GRAPH_TRANSFER_UTILS_H_
#define TENSORFLOW_PLATFORM_OVX_GRAPH_TRANSFER_UTILS_H_
...
#endif  // TENSORFLOW_PLATFORM_OVX_GRAPH_TRANSFER_UTILS_H_
