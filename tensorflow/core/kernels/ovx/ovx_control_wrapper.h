...
#ifndef THIRD_PARTY_TENSORFLOW_CORE_KERNELS_OVX_CONTROL_WRAPPER_H_
#define THIRD_PARTY_TENSORFLOW_CORE_KERNELS_OVX_CONTROL_WRAPPER_H_
...
#endif  // THIRD_PARTY_TENSORFLOW_CORE_KERNELS_OVX_CONTROL_WRAPPER_H_
