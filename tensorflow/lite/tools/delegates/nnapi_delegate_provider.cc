...
void NnapiDelegateProvider::LogParams(const ToolParams& params) const {
  ...
  if (params.Get<bool>("use_nnapi")) {
    ...
    std::string cache_dir_log_string = "cache_model_dir: [" +
                              params.Get<std::string>("cache_model_dir") +
                             "]";
    TFLITE_LOG(INFO) << cache_dir_log_string;
    std::string cache_token_log_string = "cache_model_token: [" +
                              params.Get<std::string>("cache_model_token") +
                             "]";
    TFLITE_LOG(INFO) << cache_token_log_string;
  }
#endif
}
